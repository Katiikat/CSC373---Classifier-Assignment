Assignment: Build your own Machine Learning Classifier using a toy dataset from SciKit Learn.
Date: Jan 24, 2021

Assignment Requirements: 
Resources for Data: https://scikit-learn.org/stable/datasets/toy_dataset.html
Code a new ML application using Python 3.x.
Pick out the toy data set that interests you the most, except for the wine dataset.
Make sure to pick out a classifier. 
